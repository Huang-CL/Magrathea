...
Magrathea has been used in published work to generate mass--radius diagrams, infer interiors of observed planets, connect theoretical composition from formation to observables, and test how updated high-pressure EOS measurements change inferred structures [@Huang:2021; @MacDonald:2022, @Childs:2023; @Desai:2024; @Dou:2024; @Steffen:2025; @Taylor:2025; @Lozovsky:2026]. The new composition finders are used and described in @Daspute:2025, @Rice:2025, and @Kroft:2026. 
