...
EOS *Fe_Seager = new EOS("Fe (Seager)", "iron.txt");
...
EOS *Si_PREM = new EOS("Si (PREM)", "SiPREM.txt");
...
EOS *Si_Seager = new EOS("Si (Seager)", "silicate.txt");
...
EOS *Ice_Seager = new EOS("Ice (Seager)", "water.txt");
