...
ternaryplot.py plots result/OneEarthTern.txt generated using run/inputternary.txt using input_mode=6 with 300 K surface temperature and 0 K jumps between layers. Usings python-ternary package: https://github.com/marcharper/python-ternary. Outputs oneearthternary.pdf.
